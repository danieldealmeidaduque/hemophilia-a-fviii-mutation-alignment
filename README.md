...
<h3 align="center"> Utilizing Point Mutations in Factor VIII to Understand Hemophilia A </h3>
...
<p align="justify">
    The project applies the point mutation in the wild FVIII and generates a mutated FVIII. Each mutation in the database is applied to generate a sequence, which is then aligned and saved in a fasta file. The mutated sequences are sliced to reduce the number of amino acids and facilitate further visualizations.
</p>

<p align="justify">
    Using the alignment file, a software called Seaview is employed to visualize the aligned sequences in color, making them easier to understand. Additionally, phylogenetic trees are generated by the same software. Since the software generates black and white phylogenetic trees, an auxiliary code was created to colorize the tree based on the severity of the mutation, which makes it easier to interpret.
</p>
